...
gudfun2015 <- read_excel("~/OneDrive - University of Bergen/Research/FunCaB/Data/funcab_Gudmedalen.xlsx")
funcab_2015 <- read_delim("~/OneDrive - University of Bergen/Research/FunCaB/Data/funcab_composition_2015.csv", delim = ";")
funcab_2016 <- read_delim("~/OneDrive - University of Bergen/Research/FunCaB/Data/funcab_composition_2016.csv", delim = ";")
