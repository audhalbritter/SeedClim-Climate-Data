...
Climate data from climate logger at 12 the SeedClim / FunCaB sites from the period of 2008 - oct 2018, hourly values
...
The raw data is stored on the UiB common server (P drive):
